...
- Se evaluará la correcta resolución del ejercicio.
- Aplicar todos los principios de buen diseño necesarios que consideres que incrementen la calidad del código.>
